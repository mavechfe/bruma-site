...
Cada item é um bloco com cabeçalho `## <id AAAA-MM-DD-n> | estado: fila|publicado`, seguido do texto do post e, opcionalmente, uma linha `imagem: <caminho absoluto no PC>`. A tarefa local publica os itens `fila` por ordem e muda o estado para `publicado`, registando no `marketing-log.md`.

## 2026-08-11-1 | estado: publicado
